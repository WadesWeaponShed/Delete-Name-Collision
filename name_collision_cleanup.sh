...
mgmt_cli -r true -d $DOMAIN show objects filter "NAME_COLLISION_RESOLVED" limit 500 --format json | jq --raw-output '.objects[] | "mgmt_cli delete " + .type + " name " + .name + " -s id.txt"' >delete_collision.txt
